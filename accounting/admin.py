...
class ЭкземплярыТехникиАдмин(admin.ModelAdmin):
    # list_display = ('id_техники_по_накладной', 'id_еденицы_техники', '_комплект', 'инвентарный_номер', 'заводской_код',
    #                 'дата_гарантии')
    #
    # def _комплект(self, obj):
    #      return str(obj.id_еденицы_техники.id_комплекта)
    #
    # _комплект.short_description = 'Комплект'
